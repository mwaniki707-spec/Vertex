...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 1299,
    image: "/images/officeconnect.svg",
    features: [
...
export const MOCK_ALERTS: Alert[] = [
  ...
  },
  {
    ...
    type: "warning",
    message:
      "Distribution Switch B reporting high CPU utilization (92%)",
  ...
  },
  {
    ...
    type: "warning",
    message:
      "SSL certificate for portal.vertex.com expires in 14 days",
  ...
  },
  {
    id: "alt_005",
    type: "critical",
    message: "Brute-force login attempt detected — 47 failed attempts from 185.220.101.x",
